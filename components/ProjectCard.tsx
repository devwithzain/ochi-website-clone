		...
		<div>
			<div className="relative w-full group">
				...
				<div
					...
					className="absolute w-fit flex top-[50%] sm:left-1/2 transform -translate-x-[30%] -translate-y-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 overflow-hidden z-10 group-hover:opacity-100 opacity-0 transition duration-500 ease-[.4,0,.2,1]">
					{item.title.split("").map((item: any, i: any) => (
						<motion.span
							...
							className="text-[165rem] leading-none inline-block uppercase font-FoundersGrotesk text-about font-bold text-center pointer-events-none"
							key={i}>
							{item}
						</motion.span>
					))}
