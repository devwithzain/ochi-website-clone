...
export default function Works() {
	return (
		<section className="w-full bg-marquee rounded-t-[20px] sticky -top-[95%]">
			<div className="w-full bg-marquee z-10 relative rounded-t-[20px] pt-[80px]">
				<Marquee
			...
			<div className="w-full flex justify-between gap-y-[50px] padding-x pb-[50px] pt-[20px] flex-wrap">
				{workizItem.map((item) => (
					<div
			...
			<div className="w-full flex pt-[30px] pb-[200px] justify-center">
